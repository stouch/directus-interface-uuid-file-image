...
declare module '@directus-extensions-display' {
	import { DisplayConfig } from './directus/app/shared/types';
	const displays: DisplayConfig[];
	export default displays;
}

declare module '@directus-extensions-layout' {
	import { LayoutConfig } from './directus/app/shared/types';
	const layouts: LayoutConfig[];
	export default layouts;
}

declare module '@directus-extensions-panel' {
	import { PanelConfig } from './directus/app/shared/types';
	const panel: PanelConfig[];
	export default panel;
}

declare module '@directus-extensions-module' {
	import { ModuleConfig } from './directus/app/shared/types';
